...
public:
	BloomPass(RendererFrontend &p_renderer) :
		...
		m_lensDirtTexture(Loaders::texture2D().load(Config::filepathVar().engine_assets_path + Config::rendererVar().lens_flare_dirt_texture, MaterialType::MaterialType_Data)),
